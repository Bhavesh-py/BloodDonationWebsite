...
<body>
    ...
    <section>
        <section id="why">
            <div class="container">
                <div class="mt-5">
                    <img src="img/give.jpg" width="1100px" alt="give blood">
                </div>
                    ...
                    <div class="col col-sm-8 col-md-6 col-lg-4 offset-sm-2 offset-md-3 offset-lg-4">
                        ...
                        <form class="mb-3">
                            ...
                            <div class="text-center">
                                <a href="OTP.jsp" class="btn btn-primary btn-block mb-3">Create Account</a>
                            </div>
        ...
        <section id="canidonate">
            <div class="container">
                ...
                <div class="grid-text" data-mh="grid-text" style="">
                    ...
                    <p>We’ll need to check that you can donate. Whether or not you can donate will depend on the
                        medication you are
